...
public class ClienteMenu extends javax.swing.JFrame {
  ...
  public ClienteMenu() {
    ...
    private void initComponents() {
        ...
        pubIcon.setForeground(new java.awt.Color(240, 140, 227));
        pubIcon.setText("NP");
        ...
        toggleButton.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        btnFood.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        btnBeer.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        btnWine.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Content.setBackground(new java.awt.Color(39, 49, 55));

        txtTitulo.setFont(new java.awt.Font("sansserif", 0, 36)); // NOI18N
        txtTitulo.setForeground(new java.awt.Color(61, 216, 252));
